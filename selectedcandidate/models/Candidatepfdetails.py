...
class CandidatePfDetails(models.Model):
    ...
    MemberNameAsPerAadhar = models.CharField(null=False, max_length=100, db_column='Member_Name_As_Per_Aadhar')
    ...
    PhysicalHandicap = models.BooleanField(default=False, db_column='Physical_Handicap')
